/**
 * Translates between logical and physical addresses for a simple paged memory system.
 *
 * The page table (PageTable) maps logical page numbers to physical page frames.
 * Logical addresses are translated to physical addresses using this mapping and the page offset.
 * Physical addresses are translated to logical addresses by searching for the page frame in PageTable.
 *
 * main() shows examples translating addresses read from input files.
 */
